...
struct yggdrasilEventVars{
  ...
  bool    GoodFirstPV_;
  bool    pass_METFilters_;
  bool    pass_MuFilters_;
  ...
  std::vector<unsigned int> lepton_seed_;
...
void yggdrasilEventVars::initialize(){
  ...
  GoodFirstPV_ = false;
  pass_METFilters_ = false;
  pass_MuFilters_ = false;
